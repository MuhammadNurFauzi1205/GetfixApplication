...
import com.example.getfixapplication.utils.ConstVal.FILENAME_FORMAT
import java.io.*
...
fun createCustomTempFile(context: Context): File {
    ...
    return File.createTempFile("imgstory_$timeStamp", ".jpg", storageDir)
}
